# Copied from https://github.com/thechangelog/changelog.com/blob/master/lib/changelog_web/plugs/turbolinks.ex
defmodule PhoenixTailwindTurbolinksSkeletonWeb.Plug.Turbolinks do
  import Plug.Conn
