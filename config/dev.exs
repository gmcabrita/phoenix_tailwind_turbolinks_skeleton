...
config :phoenix_tailwind_turbolinks_skeleton, PhoenixTailwindTurbolinksSkeleton.Repo,
  username: "postgres",
  password: "postgres",
  database: "phoenix_tailwind_turbolinks_skeleton_dev",
  hostname: "localhost",
...
config :phoenix_tailwind_turbolinks_skeleton, PhoenixTailwindTurbolinksSkeletonWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/phoenix_tailwind_turbolinks_skeleton_web/(live|views)/.*(ex)$",
      ~r"lib/phoenix_tailwind_turbolinks_skeleton_web/templates/.*(eex)$"
    ]
  ]
